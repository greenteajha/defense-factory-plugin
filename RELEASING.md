...
3. Run `python3 scripts/check-package.py` and `claude plugin validate .`. Review the file inventory for secrets and unnecessary assets. Confirm each skill's positive trigger, non-trigger, missing-access behavior, and evidence output.
